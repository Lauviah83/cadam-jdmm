...
<style>
  ...
  * {{ box-sizing: border-box; }}
  ...
  .planche {{
    /* 209 mm, pas 210 : à la hauteur exacte de la page, le moteur d'impression
       déborde d'un pixel et sort une seconde page blanche. */
    width: 148mm; height: 209mm; overflow: hidden; padding: 14mm 13mm;
